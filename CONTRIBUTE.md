...
- areeb/feature/document-generation
...
1. **Create a fork**
- Create a fork from this repository selecting (RebelVerse)[https://github.com/muhammadareeb01] as the owner and then open your forked repo in your profile 
- Clone repo in your local workspace and start implementing features/fixing bugs/writinf documentation etc.

2. **Create a branch**: 
    ```sh
    git checkout -b areeb/feature/your-feature-name
    ```
...
5. **Push to the branch**: 
    ```sh
    git push origin areeb/feature/your-feature-name
    ```
6. **Open a pull request**: Go to the repository and click on "Compare & pull request".

After the submission of your PR, if it's follows our convensions an Owner/Authorized admins will have a look at your PR and accept/reject with given feedback. You can expect to get a valuable feedback and more activity on your profile from an owner of this project [RebelVerse](https://github.com/muhammadareeb01) and/or admins reviewing your PR :)
