              ...
              {[
                {
                  icon: <Mail />,
                  label: 'EMAIL ME',
                  value: 'syedareebali795@gmail.com',
                  href: 'mailto:syedareebali795@gmail.com',
                },
                {
                  icon: <Phone />,
                  label: 'CALL ME',
                  value: '+92 331 3521879',
                  href: 'tel:+923313521879',
                },
              ].map((item, i) => (
                <motion.a
                  key={i}
                ...
                >
                  ...
                  <div>
                    <div className="text-[10px] font-black tracking-widest text-muted-foreground uppercase mb-1">
                      {item.label}
                    </div>
            ...
            <div className="p-8 md:p-12 rounded-[2.5rem] bg-card border border-border shadow-2xl">
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="space-y-2">
                  <label className="text-xs font-black tracking-widest text-muted-foreground uppercase ml-2">
                    YOUR EMAIL
                  </label>
                  <input
                    type="email"
