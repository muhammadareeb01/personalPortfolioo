...
export const metadata: Metadata = {
  ...
  description:
    'Check out modern and stylish portfolio of RebelVerse - an experienced Web Development agency! Built using TypeScript, Next.js 14, Framer Motion and Tailwind CSS.',
};
